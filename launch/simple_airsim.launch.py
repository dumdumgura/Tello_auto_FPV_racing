...
def generate_launch_description(): 
    ...
    return LaunchDescription([
       # SetEnvironmentVariable('GAZEBO_MODEL_PATH', os.path.join(get_package_share_directory('fpv_racing_gazebo'), 'models')),
        ...
        #Node(package='tello_mod',executable='image_receive',output='screen',namespace=ns),
        ...
        Node(package='tello_mod',executable='polynomial_path_planner', output='screen',namespace=ns),
        Node(package='tello_mod',executable='orb_pid_teleop_sim', output='screen',namespace=ns),

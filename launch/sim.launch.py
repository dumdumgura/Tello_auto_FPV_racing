...
def generate_launch_description():
    ...
    world_path = os.path.join(get_package_share_directory('fpv_racing_gazebo'), 'worlds','labor_worlds','demo1.world')
    ...
    return LaunchDescription([
       ...
       #    PythonLaunchDescriptionSource(apriltag_ros_path)
        ...
        #Node(package='tello_mod',executable='base_tf2_broadcaster', output='screen',parameters=[{'use_sim_time': True}]), #tf would also be influenced by namespace.

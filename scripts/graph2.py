...
class graph(Node):
    def __init__(self):
        ...
        self.azplot.title.set_text('control_az')
        self.xplot.title.set_text('control_x')
        self.yplot.title.set_text('control_y')
        self.zplot.title.set_text('control_z')
    ...
    def listener_callback(self,msg):
        ...
        self.erraz.append(float(np.round((msg.angular.z*180/3.1415926),decimals=2)))
        self.errx.append(float(msg.linear.x))
        self.erry.append(float(msg.linear.y))

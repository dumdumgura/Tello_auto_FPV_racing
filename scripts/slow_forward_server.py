...
class slow_rotate_server(Node):
    def __init__(self):
        super().__init__('slow_forward_server')
        self.pub = self.create_publisher(Twist,'/drone1/cmd_vel',5)
        self.create_service(SetBool,'slow_forward',self.foward_callback)
    ...
    def foward_callback(self,req,res):
